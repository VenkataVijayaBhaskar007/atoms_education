...
const Section1 = () => {
  const data = [
      ...
      desc: (
        <>
          ...
          <div className="space-y-4 mt-4">
            ...
            {/* Additional content after SVG icon */}
            <div className="flex items-center space-x-4">
            <div className="flex-shrink-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex-shrink-0">
              ...
              <div className="text-black text-base font-normal font-['Poppins'] leading-relaxed md:whitespace-nowrap">
              Design and train stakeholders with customisable Standard Operating Procedures
              </div>
            </div>
          </div>
    ...
    },
    {
        ...
        <>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="text-black text-base font-normal font-['Poppins'] leading-relaxed md:whitespace-nowrap">
                Strategies to increase the volume of admissions
              </div>
            </div>
            <div className="flex items-center space-x-4">
            <div className="flex-shrink-0">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="text-black text-base font-normal font-['Poppins'] leading-relaxed md:whitespace-nowrap">
                Student academic performance improvement programs
              </div>
            </div>
            <div className="flex items-center space-x-4">
            <div className="flex-shrink-0">
              ...
              <div className="text-black text-base font-normal font-['Poppins'] leading-relaxed md:whitespace-nowrap">
                Train students and teachers with theoretical, practical, and digital learning
              </div>
            </div>
            ...
            <div className="flex-shrink-0">
              ...
              <div className="text-black text-base font-normal font-['Poppins'] leading-relaxed md:whitespace-nowrap ">
                Student all-round development activities
              </div>
            </div>
          </div>
          {/* ... (similar structure for other points) */}
      ...
      nestedTabs: [ // Add nested tabs configuration
        {
            ...
            <>
              ...
              <div className="space-y-4 mt-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-black text-base font-normal font-['Poppins'] leading-relaxed md:whitespace-nowrap">
                  The Acumen Club - a space to learn and communicate in english
                  </div>
                </div>
                {/* Additional content after SVG icon */}
                <div className="flex items-center space-x-4">
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="text-black text-base font-normal font-['Poppins'] leading-relaxed md:whitespace-nowrap">
                Financial and economic knowledge sessions
                  </div>
                </div>
              </div>
              {/* ... (similar structure for other points) */}
...
<section className="my-4 " style={{ marginTop: "8rem" }}>
  ...
  >
    ...
    <div className="lg:order-1 lg:w-1/2 lg:pr-4 ">
      <img
        src="./images/educationcards/25.png" // Replace with the actual image URL
        alt="About Image"
...
<section className="mb-30"> 
      <Tabs className=" px-5" >
        ...
        <TabsBody>
          {data.map(({ value, desc, nestedTabs }) => (
            <TabPanel key={value} value={value}>
              {desc}
              {nestedTabs && (
                <Tabs value={nestedTabs[0].value}>
                  <TabsHeader className="bg-blue-200 ">
                    {nestedTabs.map(({ label, value }) => (
                      <Tab key={value} value={value}>
                        {label}
                      </Tab>
                    ))}
