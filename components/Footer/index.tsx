...
export default function Footer() {
  return (
    ...
    <a href="https://www.facebook.com/profile.php?id=100088185383280&mibextid=VqkefZtyiaKY4pB6" className="mr-6 text-neutral-800 dark:text-neutral-200">
    <svg
  ...
  <path
    d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
      ...
      <a href="https://www.linkedin.com/company/atoms-education-pvt-ltd/" className="mr-6 text-neutral-800 dark:text-neutral-200">
      <svg
  xmlns="http://www.w3.org/2000/svg"
  className="h-4 w-4"
  fill="white"
  ...
  <path
    d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
      ...
      <a href="https://instagram.com/atoms.ed?igshid=NGVhN2U2NjQ0Yg==" className="mr-6 text-neutral-800 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
               className="h-5 w-4"
          fill="white"
      ...
      <a href="mailto:atomseducation1@gmail.com" className="mr-6 text-neutral-800 dark:text-neutral-200" style={{marginTop:"-2px"}}>
      <svg
  width="23"
  height="24"
  viewBox="0 0 24 24"
